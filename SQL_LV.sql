...
ALTER TABLE
    SANPHAM
ADD
    CONSTRAINT CPU FOREIGN KEY (CPU) REFERENCES CPU (ID);

ALTER TABLE
    SANPHAM
ADD
    CONSTRAINT RAM FOREIGN KEY (RAM) REFERENCES RAM (ID);

ALTER TABLE
    SANPHAM
ADD
    CONSTRAINT HANG FOREIGN KEY (THUONGHIEU) REFERENCES HANG (ID);

ALTER TABLE
    SANPHAM
ADD
    CONSTRAINT HEDIEUHANH FOREIGN KEY (HEDIEUHANH_ID) REFERENCES HEDIEUHANH (ID);

ALTER TABLE
    SANPHAM
ADD
    CONSTRAINT OCUNG FOREIGN KEY (OCUNG_ID) REFERENCES OCUNG (ID);
