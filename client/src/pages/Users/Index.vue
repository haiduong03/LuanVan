        ...
        <div class="col-12">
          ...
          >
            ...
            <div style="text-align: right">
              <router-link to="/quanlyuser/adduser">
                <button
              ...
              <tbody>
                <tr v-for="(use, index) in users" :key="index">
                  ...
                  <td style="text-align: center">
                    <router-link :to="`/quanlyuser/${use._id}/manage`">
...
export default {
  ...
  methods: {
    async solieu() {
      this.data = await axios.get(`http://10.42.240.200:9999/api/users`);
